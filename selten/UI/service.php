    ...
    <div class="container s-container">
        ...
        <div class="row mainservices s-row ">
            ...
            <div class="col-md-4 mb-5">
                ...
                <div class="card card-head card-2 m-3 pt-3">
                    ...
                    <!-- <div>
                        ...
                        <center> <button class="btn btn-danger know-more mt-3"><a href="" class="know-more-button know-more-2">Know More</a></button></center>
                    </div> -->
                </div>
            </div>
            <div class="col-md-4 mb-5">
            ...
            <div class="col-md-4 mb-5">
                ...
                <div class="card card-head card-5 m-3 pt-3">
                    <div class="sheading">
                        <h4>INTEGRATION<br> SERVICVES</h4>
                    </div>
                    <div class="sicon rounded-circle">
                        <i class="fa-solid fa-gear   sicon-icon  fa-3x"></i>
                    </div>
                    <div class="spara">
                        <p>An organization can't rely upon a single application alone to improvise their business.
                            So
                            various applications should converse with each other to make the business progressively
                            significant. We at Selten Technologies give the most ideal approaches to keep the
                            information in a state of harmony between different applications. Selten Technologies
                            boosts
                            up your business with our eminent integration service.</p>
                    </div>
                    <!-- <div>
                        <center> <button class="btn btn-danger know-more mt-3"><a href="" class="know-more-button know-more-5">Know More</a></button></center>
                    </div> -->
                </div>
            </div>
            <div class="col-md-4 mb-5">
                ...
                <div class="card card-head card-6 m-3 pt-3">
                    <div class="sheading">
                        <h4>E <br>COMMERCE</h4>
                    </div>

                    <div class="sicon rounded-circle">
                        <!-- <img src="..\images\icon\chart-simple-solid.svg" class="sicon-icon " alt="" srcset=""> -->
                        <i class="fa-sharp fa-solid fa-chart-simple sicon-icon   fa-3x"></i>
                    </div>
                    <div class="spara">
                        <p>Nowadays internet shopping rules the shopping world with its enormous wings of e-commerce
                            platforms. The vast majority of the individuals select to shop on the web than twisting
                            into
                            different shops considering time management as a major factor. Having an online store
                            truly
                            turns out to be as it is every minute of everyday shop that is kept open on the web and
                            deals will be going on dynamically.</p>
                    </div>
                    <!-- <div>
                        <center> <button class="btn btn-danger know-more mt-5"><a href="" class="know-more-button know-more-6">Know More</a></button></center>
                    </div> -->
                </div>
            </div>
